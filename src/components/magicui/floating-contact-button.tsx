...
export const FloatingContactButton = ({
  ...
  const openWhatsApp = (number: string) => {
    ...
    window.open(
      `https://wa.me/${number.replace(/\D/g, "")}?text=${encodedMessage}`,
      "_blank"
    );
  };
  ...
  const whatsappNumbers = contactInfo?.phoneNumbers?.filter(
    (phone) => phone.phoneType === "whatsapp"
  ) || [];
  ...
  // Get primary email
  const primaryEmail = contactInfo?.emails?.find((email) => email.primary) || contactInfo?.emails?.[0];
      ...
      {(
        ...
        >
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                className="mb-4 p-4 bg-white dark:bg-background rounded-lg shadow-lg border border-primary/50 dark:border-primary/30 max-w-xs sm:max-w-sm"
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {whatsappNumbers.map((phone, index) => (
                          <button
                            ...
                            className="py-2 px-3 bg-green-500 hover:bg-green-600 text-white text-xs font-medium rounded-md transition-colors duration-200 flex items-center justify-center"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {mobileNumbers.map((phone, index) => (
                          <a
                            ...
                            className="py-2 px-3 bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium rounded-md transition-colors duration-200 flex items-center justify-center"
                          >
                  ...
                  {primaryEmail && (
                    <div className="space-y-2">
                      ...
                      <a
                        ...
                        className="py-2 px-3 bg-purple-500 hover:bg-purple-600 text-white text-xs font-medium rounded-md transition-colors duration-200 flex items-center justify-center"
                      >
