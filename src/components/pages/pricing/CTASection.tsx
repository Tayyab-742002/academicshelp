...
export default function CTASection() {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-white/10 to-transparent opacity-50"></div>
      <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-black/10 to-transparent opacity-30"></div>
        ...
        >
          ...
          >
            <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 400 }}>
              <Link
                href="/contact"
                className="px-8 py-4 rounded-full bg-white hover:bg-gray-50 text-primary font-medium text-center transition-all duration-300 shadow-xl shadow-primary/20 inline-block dark:bg-white dark:hover:bg-gray-100 relative overflow-hidden group"
              >
            ...
            <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 400 }}>
              <Link
                href="/services"
                className="px-8 py-4 rounded-full bg-transparent border-2 border-white/80 hover:bg-white/10 text-white font-medium text-center transition-all duration-300 inline-block dark:border-white/90 relative overflow-hidden group"
              >
                {/* Button highlight effect */}
