...
export default function HeroSection() {
  ...
  const buttonVariants = {
    hover: { scale: 1.05, boxShadow: "0 10px 25px -5px rgba(229, 62, 62, 0.4)" },
    tap: { scale: 0.98 },
  };

  return (
    <section ref={heroRef} className="relative min-h-[90vh] flex items-center overflow-hidden py-16 md:py-24">
        ...
        >
          ...
          <div className="lg:w-1/2 order-2 lg:order-1">
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Get premium assistance with essays, research papers, and assignments from our elite team of academic experts. Achieve the excellence you deserve.
            </motion.p>
            ...
            >
              ...
              >
                <Link
                  href="/services"
                  className="inline-flex items-center justify-center px-8 py-4 rounded-full border-2 border-primary/50 text-foreground font-medium text-center transition-all duration-300 hover:text-primary hover:bg-primary/5 w-full sm:w-auto backdrop-blur-sm"
                >
            ...
            >
              ...
              <motion.div 
                ...
                whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(255, 107, 107, 0.1), 0 10px 10px -5px rgba(255, 107, 107, 0.04)" }}
              >
            ...
            <div className="relative w-full aspect-square max-w-md mx-auto sm:max-w-lg">
              ...
              >
                ...
                <motion.div
                  ...
                  whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(229, 62, 62, 0.2)" }}
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-xs sm:text-sm font-medium text-foreground">Plagiarism-Free</div>
                      <div className="text-xs text-muted-foreground hidden sm:block">100% Original Content</div>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(255, 107, 107, 0.2)" }}
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-xs sm:text-sm font-medium text-foreground">On-Time Delivery</div>
                      <div className="text-xs text-muted-foreground hidden sm:block">Never Miss a Deadline</div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-[10px] sm:text-xs font-medium">500+ Writers Online</div>
                </motion.div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-12 sm:h-16 text-background dark:text-background">
          <defs>
