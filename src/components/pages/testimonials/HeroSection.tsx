        ...
        >
          <div className="inline-block mb-3">
            <div className="flex items-center justify-center space-x-2 bg-primary/5 dark:bg-primary/10 px-4 py-1.5 rounded-full">
              ...
              <span className="text-sm font-medium text-primary">Real Student Experiences</span>
            </div>
          </div>
          ...
          >
            Hear from students who have achieved academic success with our expert assistance. 
            These testimonials reflect real experiences from students at various academic levels.
          </motion.p>
