...
export default function ContactInfo() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      icon: (
        <svg className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-1.257.845a1.1 1.1 0 00-.44 1.684l1.257.844a1.1 1.1 0 01.44 1.684l-1.257.845a1.1 1.1 0 00-.44 1.684l1.257.844a1.1 1.1 0 01.502 1.21l-1.498 4.493a1 1 0 01-.948.684H5a2 2 0 01-2-2V5z" />
        </svg>
      ),
    },
    {
        ...
        >
          ...
          >
            {contactMethods.map((method, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-card/95 to-card/70 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-primary/20 dark:border-primary/30 shadow-lg hover:shadow-xl transition-all duration-300 h-full relative overflow-hidden">
                  <div className="absolute -right-6 -bottom-6 w-24 h-24 rounded-full bg-accent/10 group-hover:bg-accent/20 transition-all duration-300" />
            ...
            <div className="flex justify-center space-x-5">
              {['facebook', 'twitter', 'instagram', 'linkedin'].map((platform, i) => (
                <motion.a 
                  ...
                  custom={i + 5}
                  variants={itemVariants}
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-card/80 border border-primary/20 dark:border-primary/30 text-muted-foreground hover:text-primary hover:border-primary/40 transition-all duration-200 shadow-sm hover:shadow"
                  whileHover={{ y: -3 }}
                >
                  {platform === 'facebook' && (
